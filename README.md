...
Responses for questions 1 to 4 have been made in separate branches which are now merged into master. To review please use the respective pull request for an overview of the changes made. Comments have been included with every change for the purpose of this test. Normally these comments would go in the PR its self as a part of the review process.
